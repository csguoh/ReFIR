...
parser.add_argument("--img_dir", type=str, default='/home/tiger/gh/dataset/RealPhoto60')
parser.add_argument("--save_dir", type=str, default='/home/tiger/gh/dataset/results/Real_Deg/SUPIR/realPhoto')
