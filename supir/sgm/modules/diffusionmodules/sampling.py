...
def adain_latent(feat, cond_feat, timestep=0, eps=1e-5, total_t=900):
...
class RestoreEDMSampler(SingleStepDiffusionSampler):
    ...
    def denoise(self, x, denoiser, sigma, cond, uc, control_scale=1.0):
        ...
        if time_step[0] >900:
            ...
            is_adain = False
        denoised = self.guider(denoised, sigma,is_adain)
        return denoised,time_step
    ...
    def sampler_step(self, sigma, next_sigma, denoiser, x, cond, uc=None, gamma=0.0, x_center=None, eps_noise=None,
        ...
        denoised,timestep = self.denoise(x, denoiser, sigma_hat, cond, uc, control_scale=control_scale)
